        ...
        * {
        ...
        @media (max-width: 445px) {
            ...
            .graph-container {
                ...
                padding: 0;
                /* Graph area takes 40% of the available width */
            }
        ...
        <div class="wrapper">
            ...
            <div class="box">
                <div class="content"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-graph-up" viewBox="0 0 16 16">
                    ...
                    <span><?php echo $appointmentsCount; ?>
                </div></span>
            </div>
                ...
                <div class="mb-3">
                    <form action="" method="POST" class="mb-4">
                        <div class="input-group mb-3">
                            ...
                            <button class="btn btn-outline-secondary" type="submit"><i class='fas fa-search'></i> <span class='d-none d-lg-inline'>Search</span></button>
                            <a href="admin/create.php" class="btn btn-primary">
                                <i class="fas fa-add"></i> <span class='d-none d-lg-inline'>Add Doctor</span>
                            </a>
                        </div>
                    </form>
                </div>
                <table>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <i class='fas fa-calendar'></i> <span class='d-none d-lg-inline'>Upcoming Appointments</span>
                        </a>
                        <a href='admin/update_doctor.php?doctor_id={$row['doctor_id']}' class='btn btn-warning'>
                            <i class='fas fa-pencil'></i> <span class='d-none d-lg-inline'>Update</span>
                        </a>
                        <a href='admin/delete.php?doctor_id={$row['doctor_id']}' class='btn btn-danger'>
